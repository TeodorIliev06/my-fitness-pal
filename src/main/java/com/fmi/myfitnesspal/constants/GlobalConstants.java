package com.fmi.myfitnesspal.constants;
...
public final class GlobalConstants {
    ...
    public static final String NOT_EXISTING_RECIPE_MESSAGE = "No such recipe in the recipe pool!";
    ...
    public static final String SUCCESSFULLY_CREATED_RECIPE_MESSAGE = "Recipe created successfully!";
    public static final String SUCCESSFULLY_ADDED_RECIPE_MESSAGE = "Recipe added successfully!";
    public static final String SUCCESSFULLY_REMOVED_RECIPE_MESSAGE = "Recipe removed successfully!";
