...
public final class ShowExercisesCommand implements ExecutableCommand {
    private static final String NAME = "show-exercises";
    private static final int ARGUMENTS_COUNT = 0;
    private final ExercisePool exercisePool;

    public ShowExercisesCommand(ExercisePool exercisePool) {
    ...
    public String execute(List<String> arguments) throws InvalidCommandException {
        ...
        List<Exercise> exercises = new ArrayList<>(exercisePool.getExercises().values());
