...
public final class ShowDailyNutrientsCommand extends ChartCommand {
    ...
    public ShowDailyNutrientsCommand(FoodDiary foodDiary, PieChartDisplayer chartDisplayer,
    ...
    protected ChartData buildChart(String argument) throws InvalidCommandException {
        ...
        DailyNutritionSummary summary = FoodCalculator.getDailyNutritionSummary(foodDiary, date);
